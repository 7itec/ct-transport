...
const useDisplaceAttendance = (attendanceId: string) => {
  ...
  return useApiMutation({
    method: "PATCH",
    url: `/jobs/${attendanceId}/displacement`,
    errorTitle: "Erro ao colocar atendimento em deslocamento",
    onSuccess,
  });
};

export default useDisplaceAttendance;
